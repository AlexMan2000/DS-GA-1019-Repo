"""
    N-body simulation. (Avoiding Loops)
"""
...
def advance(dt):
    ...
    for (body1, body2) in combinations(BODIES.keys(), 2):
        (pos1, v1, m1) = BODIES[body1]
        (pos2, v2, m2) = BODIES[body2]
        (dx, dy, dz) = compute_deltas(pos1[0], pos2[0], pos1[1], pos2[1], pos1[2], pos2[2])
