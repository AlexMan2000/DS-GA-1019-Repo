"""
    N-body simulation. (Better Membership Testing)
"""
...
def report_energy(e=0.0):
    ...
    '''
    seenit = set() # Change to set
    # Bad way of writing dict test as key in dict.keys(), should be key in dict, much faster in python2
    for body1 in BODIES:
        for body2 in BODIES:
            if (body1 != body2) and not (body2 in seenit):
                ((x1, y1, z1), v1, m1) = BODIES[body1]
